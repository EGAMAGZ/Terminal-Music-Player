...
class TestFile(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.wsl_path='/mnt/c/Users/{}/Music'.format(self.username)
        self.linux_path='/home/{}/Music'.format(self.username)

    def test_get_default_path(self):
        self.assertIn(self.file_class.get_file_path(),[self.win_path,
        self.wsl_path,self.linux_path])
    ...
    def test_set_file_path(self):
        ...
        self.assertNotIn(self.file_class.get_file_path(),[self.wsl_path,self.linux_path])

        # Set default file path for wsl
        self.file_class.set_file_path(self.wsl_path)
        self.assertEqual(self.file_class.get_file_path(),self.wsl_path)
        self.assertNotIn(self.file_class.get_file_path(),[self.win_path,self.linux_path])
        ...
        self.assertNotIn(self.file_class.get_file_path(),[self.win_path,self.wsl_path])
